...
@dataclass
class VAEConfig:
    latent_dim: int = 20  # TODO: choose dz
...
def main():
    ...
    save_image_grid(x_hat, "test.png", title="Generation of samples (drawn from multivariate normal distribution with N(0, I))")
